...
import com.yt.ecommerce.entity.ImageModel;
import com.yt.ecommerce.entity.Product;
import com.yt.ecommerce.service.ProductService;
...
public class ProductController {
	...
	public List<Product> getAllProducts(@RequestParam(defaultValue = "0") int pageNumber,
		...
		return (List<Product>) productService.getAllProduct(pageNumber, searchKey);
	}
